...
#[program]
pub mod solanaescrow {
    use super::*;

    pub fn initialize_new_grant(ctx: Context<initializeNewGrant>,application_idx:u64,state_bump:u8,amount:u64) -> Result<()> {
        ...
        msg!("Initialised new safe Transfer instance for {}",amount);
...
pub struct InitializeNewGrant<'info> {
    ...
    system_program: Account<'info,System>,
    token_program:Account<'info,Token>,
